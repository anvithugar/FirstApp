...
public class Mech2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview =(WebView)findViewById(R.id.webviewmec2);
        progressbar = (ProgressBar) findViewById(R.id.progressbarmec2);
