...
public class Civil2Activity extends AppCompatActivity {
    WebView webview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview =(WebView)findViewById(R.id.webviewcivil);
        progressbar = (ProgressBar) findViewById(R.id.progressbarcivil);
